...
Sessions run **Tuesday and Thursday, 19:00–20:30**, from 2026-08-11 to 2026-12-01, with a single exception: `session-10` (Thu 2026-09-17) runs **19:00–20:00**, because the opening class of the containers unit is given without computers. `course/0_index.md` states the schedule and that one exception; the two move together. `calesc2026.pdf` at the repo root is the ITAM academic calendar those dates come from.
