...
Entre «contenedor» y «máquina virtual» hay cosas en medio, y una de ellas aparece aquí por primera vez: **gVisor**, que no pone un kernel real ni renuncia a poner uno, sino que **reimplementa la interfaz de syscalls de Linux en espacio de usuario** y atiende ahí las llamadas de tu proceso. La figura 2 es la que se desarma entera en la sesión 3; por ahora quédate con que no es una recta de «poco» a «mucho» aislamiento, sino dos preguntas distintas que se responden por separado.
